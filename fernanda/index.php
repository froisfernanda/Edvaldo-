...
<html>
    ...
    <form name = "func" method = "post" >
        ...
        <input type ="submit" name = "botao" id="cadastrar-o-botao" value = "Cadastrar" />
        <input type ="submit" name = "botao" id="excluir-o-botao" value = "Excluir" />
        <br />
        <input type="text" name = "pesquisa" />
        <input type="submit" name = "botao" id="recuperar-o-botao" value = "Recuperar" />
        <input type="submit" name = "botao" id="alterar-o-botao" value = "Alterar" />
    </form>
    <table>
        <tr>
            <td>-</td>
